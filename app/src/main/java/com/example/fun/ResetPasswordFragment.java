...
public class ResetPasswordFragment extends Fragment {
   ...
   private ProgressBar progressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        goBack = view.findViewById(R.id.tv_forgor_password_go_back);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        resetPasswordBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                TransitionManager.beginDelayedTransition(emailIconContainer);// Удобный метод для анимации новой сцены, определяемый всеми изменениями в данном корне сцены между вызовом этого метода и следующим кадром рендеринга.
                               ...
                               if (task.isSuccessful()){
                                   ...
                                   scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
                                       ...
                                       public void onAnimationEnd(Animation animation) {
                                            emailIconText.setText("Recovery email sent successfully ! check inbox");
                                       ...
                                       public void onAnimationRepeat(Animation animation) {
                                           emailIcon.setImageResource(R.mipmap.btn_email);
                                       }
                                   });
