...
public class GridProductViewLayoutAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        View view;
        if (convertView == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontel_scroll_item_layout, null);
            view.setElevation(0);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent productDetailsIntent = new Intent(parent.getContext(), PdoductDetailActivity.class);
